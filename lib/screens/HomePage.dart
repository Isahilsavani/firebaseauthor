...
import 'package:firebaseauthor/colour.dart';
...
class _HomepageState extends State<Homepage> {
  ...
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance.collection('counter').snapshots();
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      IconButton(
                                          onPressed: () {
                                            CloudFireStoreHelper.cloudFireStoreHelper.deleteData(id: queryDocumentSnapshot[i].id);
                                          },
                                          icon: const Icon(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                // onChanged: (),
                decoration: const InputDecoration(border: OutlineInputBorder(), hintText: 'Enter note title', labelText: 'title'),
              ),
              const SizedBox(
                height: 10,
              ),
              TextFormField(
                ...
                // onChanged: (),
                decoration: const InputDecoration(border: OutlineInputBorder(), hintText: 'Enter note', labelText: 'Note'),
              ),
              const SizedBox(
                height: 10,
              ),
          ...
          ElevatedButton(
            onPressed: () async {
              if (insertForKey.currentState!.validate()) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Record of $name insertd succecs")));
              }
